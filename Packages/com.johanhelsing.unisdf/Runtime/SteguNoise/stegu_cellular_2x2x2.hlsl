#ifndef JGJK_STEGU_CELLULAR_2x2x2_HLSL
#define JGJK_STEGU_CELLULAR_2x2x2_HLSL
...
// Sped up by using 2x2x2 search window instead of 3x3x3,
// at the expense of some pattern artifacts.
// F2 is often wrong and has sharp discontinuities.
// If you need a good F2, use the slower 3x3x3 version.
float2 stegu_cellular2x2x2_f1f2(float3 P)
{
...
#define jitter 0.8 // smaller jitter gives less errors in F2
    ...
    float4 p2 = permute(p + Pi.z + float4(1,1,1,1)); // z+1
...
// Cellular noise, returning F1
// Sped up by using 2x2x2 search window instead of 3x3x3,
// at the expense of some pattern artifacts.
float stegu_cellular2x2x2_f1(float3 P)
{
#define K 0.142857142857 // 1/7
#define Ko 0.428571428571 // 1/2-K/2
#define K2 0.020408163265306 // 1/(7*7)
...
// with cell index
void stegu_cellular2x2x2_fi1(float3 P, out float f1, out float3 i1)
{
#define K 0.142857142857 // 1/7
#define Ko 0.428571428571 // 1/2-K/2
#define K2 0.020408163265306 // 1/(7*7)
...
DECLARE_3F_1F(stegu_cellular2x2x2_f1);
DECLARE_3F_2F(stegu_cellular2x2x2_f1f2);

void stegu_cellular_2x2x2_fi1_float(float3 p, out float distance, out float3 i)
{
    stegu_cellular2x2x2_fi1(p, distance, i);
}
